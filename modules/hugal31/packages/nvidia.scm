    ...
    (source
     (origin
       ...
       (patches (search-patches
                 "hugal31/packages/patches/nvidia/nvidia-driver-buildfix_kernel_5.4.patch"
                 "hugal31/packages/patches/nvidia/nvidia-driver-disable_fstack-clash-protection_fcf-protection.patch"))
         ...
         (add-after 'install 'install-copy
           (lambda* (#:key inputs native-inputs outputs #:allow-other-keys)
             ...
             (let* ((out (assoc-ref outputs "out"))
               ...
               (install-file "libglxserver_nvidia.so.435.21"
